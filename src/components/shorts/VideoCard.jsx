  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        <ActionBtn
          icon={
            <svg width="28" height="28" viewBox="0 0 24 24" fill={review.isLiked ? '#ff4d6d' : 'none'}>
              <path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z" stroke={review.isLiked ? '#ff4d6d' : T.white} strokeWidth="2"/>
            </svg>
          }
          label={fmtNum(review.likes)} active={review.isLiked} activeColor="#ff4d6d"
        ...
        <ActionBtn
          icon={
            <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
              <circle cx="12" cy="12" r="9" stroke={T.gray400} strokeWidth="1.5"/>
              <path d="M12 8V12" stroke={T.gray400} strokeWidth="2" strokeLinecap="round"/>
              <circle cx="12" cy="16" r="1" fill={T.gray400}/>
            </svg>
          }
          label="신고" labelColor={T.gray500} onClick={() => openReport(review.id)}
        />
      </div>
      ...
      <div style={{ position: 'absolute', bottom: 20, left: 14, right: 80 }}
        ...
        <button onClick={() => setScreen('product')} style={{
          ...
          borderRadius: 10, padding: '8px 12px', border: 'none', cursor: 'pointer', maxWidth: '100%',
        }}>
          <div style={{
            width: 30, height: 30, borderRadius: 6, flexShrink: 0,
            background: review.accentColor + '33', border: `1px solid ${review.accentColor}55`,
            display: 'flex', alignItems: 'center', justifyContent: 'center',
          }}>
          ...
          <div style={{ textAlign: 'left', overflow: 'hidden' }}>
            <p style={{ fontSize: 11, color: 'rgba(255,255,255,0.65)', margin: 0 }}>{review.product.brand}</p>
        ...
        <div style={{ display: 'flex', gap: 6, marginTop: 8 }}>
          <div style={{
            background: 'rgba(255,208,78,0.18)', border: '1px solid rgba(255,208,78,0.45)',
          ...
          {review.bonusPoints > 0 && (
            <div style={{
              background: 'rgba(232,0,61,0.18)', border: '1px solid rgba(232,0,61,0.35)',
              borderRadius: 9999, padding: '3px 10px',
            }}>
      ...
      <div style={{
        ...
        background: 'rgba(0,0,0,0.32)', borderRadius: 9999, padding: '3px 10px',
      }}>
